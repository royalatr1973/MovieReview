...
/**
 * Chennai cinema data — authoritative 34-theater list with Google Maps verified
 * coordinates. IDs match the mobile app so geofence visit IDs resolve on sync.
 * Radius is a flat 100m per venue.
 */
const cinemas = [
